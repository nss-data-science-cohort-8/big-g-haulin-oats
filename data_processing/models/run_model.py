...
file_name = 'preprocessed_data/mlflow_test_05_01'
mlflow.set_experiment("big-g-haulin-oats")
mlflow.autolog()
with mlflow.start_run():
    train_data_file_path = f"data_processing/{file_name}_train.csv"
    test_data_file_path = f"data_processing/{file_name}_test.csv"
    ...
    #simple_model = RidgeClassifier(alpha=1.0, random_state=42)  # Using RidgeClassifier as an example
